...
% Tiks Figures
\usepackage{xcolor, tikz, tikzpeople, calc, dirtree}
\usetikzlibrary{babel, shapes, decorations.pathreplacing, arrows}
\input{wheelchart}
...
\def \titreRapport {Rapport final}
\def \dateRemise {15 août 2018}
