...
% flyaway_schema_history
  \node[draw, rounded corners, align=center, anchor=north] at (0,6.3)%
{%
...
% oauth_access_token
  \node[draw, rounded corners, align=center, anchor=north] at (8,8.2)%
{%
...
% oauth_client_details
  \node[draw, rounded corners, align=center, anchor=south] at (8,0)%
{%
